...
#[TypeScript]
class AlienationMovablePropertyData extends Data
{
    public function __construct(
        public int $id,
        public string $creditor,
        public ?int $office,
        public ?string $guarantee_movable_property_description,
        public ?string $contract_registry_data,
        ...
        public ?string $contract_registry_office,
    ) {}
}
