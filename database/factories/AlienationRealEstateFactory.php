...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\AlienationRealEstate>
 */
class AlienationRealEstateFactory extends Factory
{
    /**
     ...
     * @var string
     */
    protected $model = AlienationRealEstate::class;
