...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\PurchaseAndSaleIncorporation>
 */
class PurchaseAndSaleIncorporationFactory extends Factory
{
    /**
     ...
     * @var string
     */
    protected $model = PurchaseAndSaleIncorporation::class;
