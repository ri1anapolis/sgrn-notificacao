...
return new class extends Migration
{
    ...
    {
        Schema::create('purchase_and_sale_incorporations', function (Blueprint $table) {
            $table->id();
            $table->string('creditor');
            $table->integer('office')->nullable();
            $table->string('committed_property_registration')->nullable();
            $table->string('committed_property_identification')->nullable();
    ...
    {
        Schema::dropIfExists('purchase_and_sale_incorporations');
    }
};
