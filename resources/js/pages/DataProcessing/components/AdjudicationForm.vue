...
const form = useForm({
    office: null,
    adjudicatedPropertyRegistration: '',
    adjudicatedPropertyIdentification: '',
    adjudicatedPropertyRegistryOffice: '',
});
function submit() {
    return;
}
...
<template>
    <form @submit.prevent="submit" class="grid grid-cols-1 gap-5 p-6">
        ...
        <InputForm id="adjudicated-property-registry-office" type="text"
            label="Cartório onde o Imóvel Adjudicado está Localizado" placeholder="Digite o nome do cartório" />
