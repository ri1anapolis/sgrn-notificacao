...
type PurchaseAndSaleSubdivisionModel = App.Data.PurchaseAndSaleSubdivisionData | null;

const props = defineProps<{
    modelValue: PurchaseAndSaleSubdivisionModel;
    errors: any;
}>();

const emit = defineEmits<{
    (e: 'update:modelValue', value: PurchaseAndSaleSubdivisionModel): void;
}>();

const defaultData: App.Data.PurchaseAndSaleSubdivisionData = {
    id: 0,
    creditor: '',
    office: null,
...
const updateField = (fieldName: keyof App.Data.PurchaseAndSaleSubdivisionData, value: string | number | boolean | null) => {
    const currentData = internalData.value;
    internalData.value = {
        ...currentData,
        [fieldName]: value,
    } as App.Data.PurchaseAndSaleSubdivisionData;
};

const handleInput = (event: Event, fieldName: keyof App.Data.PurchaseAndSaleSubdivisionData, type: 'text' | 'number') => {
