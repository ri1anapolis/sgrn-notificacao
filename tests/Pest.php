...
| PHPUnit test case class. By default, that class is 'PHP-Unit\Framework\TestCase'.
...
| expectations and matchers that let you check values in a very expressive way.
|
*/
